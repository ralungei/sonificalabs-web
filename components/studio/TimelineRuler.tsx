...
export function TimelineRuler({
  ...
  return (
    <div className="flex h-7 border-b border-white/[0.04] bg-surface-0/30">
      <div
        className="shrink-0 sticky left-0 z-20 bg-surface-1/95 backdrop-blur-sm border-r border-white/[0.04]"
